...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1,0, 0)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1,0, 0)),
            VertexFormat(glm::vec3(0.5f, 0, 0.867f), glm::vec3(0, 1, 1), glm::vec3(1,0, 0)),
            VertexFormat(glm::vec3(0.5f, 0.867f, 0.289f), glm::vec3(0, 1, 1), glm::vec3(1,0, 0)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    {
        vector<VertexFormat> vertices;
        vertices.push_back(VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)));

        for (int i = 1; i <= ic; i++)
        {
            vertices.push_back(VertexFormat(glm::vec3(xc, 0, zc), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)));
            xc = xc + d * cos(2 * M_PI / ic * i);
            zc = zc + d * sin(2 * M_PI / ic * i);
        }
    ...
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.50f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 0, 1), glm::vec3(0.50f));

    // TODO(student): Disable face culling
    glDisable(GL_CULL_FACE);

    RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(-1, 1, -1), glm::vec3(0.50f));
