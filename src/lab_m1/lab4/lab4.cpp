...
float x_lab4 = 0, y_lab4 = 0, scaleX_lab4 = 0, scaleY_lab4 = 0;
glm::vec3 a(-1, 0, 0);
glm::vec3 b(1, 0, 1);
...
Lab4::Lab4()
{
    ...
    meshes[line->GetMeshID()] = line;
    
}

void m1::Lab4::DrawLine(glm::vec3 a, glm::vec3 b) {
    
    /*
    glm::mat4 m = glm::transpose(
                        glm::mat4(a.x, 0, 0, b.x,
                                    0, a.y, 0, b.y,
                                    0, 0, a.z, b.z,
                                    0, 0, 0, 1));
                                    */
    ...
    modelMatrix *= transform3D::Scale(a.x, a.y, a.z);
    //modelMatrix *= transform3D::Translate(b.x + a.x, b.y + a.y, b.z + a.z);

    RenderMesh(meshes["generatedLine"], shaders["VertexColor"], modelMatrix);
}
...
void Lab4::Update(float deltaTimeSeconds)
{
    ...
    glViewport(miniViewportArea.x + x_lab4, miniViewportArea.y + y_lab4, miniViewportArea.width + scaleX_lab4, miniViewportArea.height + scaleY_lab4);
    RenderScene();
...
void Lab4::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_U) {
        scaleX_lab4 = scaleX_lab4 + 10;
        scaleY_lab4 = scaleY_lab4 + 10;
    }
    if (key == GLFW_KEY_O) {
        scaleX_lab4 = scaleX_lab4 - 10;
        scaleY_lab4 = scaleY_lab4 - 10;
