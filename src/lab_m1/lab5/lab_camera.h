...
namespace implemented
{
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_Bonus(float angle)
        {
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            // to normalize the vectors!
            up = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(up, 1);
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            glm::vec3 target = position + forward * distanceToTarget;
            position -= target;
        ...
        void RotateThirdPerson_OY(float angle)
        {
            // TODO(student): Rotate the camera in third-person mode around
            // the OY axis.
            glm::vec3 newPosition = glm::rotate(glm::mat4(1.0f), angle, up) * glm::vec4(position - GetTargetPosition(), 1.0f);

            // Set the new camera position
            position = GetTargetPosition() + newPosition;
        }
